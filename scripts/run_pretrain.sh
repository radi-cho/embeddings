...
: "${OUTPUT_DIR:=${ROOT}/data/outputs/stage1-instruction-aware-10k}"
...
: "${WANDB_RUN_NAME:=stage1-instruction-aware-10k-8xH100}"
...
[ "${USE_OPTIMIZED_MIX}" = "true" ] && ARGS="${ARGS} --use_optimized_mix"
