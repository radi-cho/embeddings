#!/usr/bin/env bash
# Merge Stage 2 LoRA checkpoints and run full MMEB eval on 8 GPUs.
set -euo pipefail
...
RESULTS_BASE="${ROOT}/results/stage2-v2-mmeb-checkpoints"

CHECKPOINTS=(500 2000 3500 5000 6500 8000 9500 final)
